...
const Damaged = () => {
  ...
  useEffect(() => {
    console.log("🔥 Application Number Changed:", applicationNo);
    console.log("🔥 Location State:", location.state);
    console.log("🔥 Initial Values:", location.state?.initialValues);
  ...
  useEffect(() => {
    const fetchInitialDropdownOptions = async () => {
      ...
      console.log("🔥 Options loaded, setting isOptionsLoaded to true");
  ...
  if (showSuccess && submittedData) {
    ...
    console.log("🔥 Submitted Data Status:", submittedData.status);
    const shouldReverseOrder = submittedData.status === "AVAILABLE" || submittedData.status === "WITH PRO";
    console.log("🔥 Should Reverse Order:", shouldReverseOrder);
    ...
    <div className={styles.Damaged_damaged_Page_Wrapper}>
      <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
        {({ values, handleChange, handleBlur, setFieldValue, errors, touched, submitForm, isSubmitting, resetForm }) => {
          ...
          console.log("🔥 Application No in form:", values.applicationNo);
          return (
