...
const FieldRenderer = ({ 
  ...
  return fields.map((field) => {
    ...
    if (field.name === "employeeId") {
      // Check if the selected quota is "Staff children"
      // Since values.quota contains the label directly, we can check it directly
      const isStaffChildSelected = values.quota === "Staff children";
    ...
    if (field.name === "admissionType") {
      console.log('=== ADMISSION TYPE FIELD DEBUG ===');
      console.log('field.name:', field.name);
      console.log('field.options:', field.options);
      console.log('admissionTypeOptions:', admissionTypeOptions);
      console.log('admissionTypeOptions length:', admissionTypeOptions.length);
      console.log('=== END ADMISSION TYPE FIELD DEBUG ===');
    }
